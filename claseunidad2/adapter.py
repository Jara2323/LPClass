#adapter (estructural): permite que dos objetos con interfaces distintas se puedan comunicar 
#strategy (comportamiento): Permite que un conjunto de clases puedan exponer distintas formas de la 
